<script lang="ts">
  let { kind, tier, size = 26 }: { kind: 'title' | 'tournament'; tier: number; size?: number } = $props();
...
<svg width={size} height={size * 1.2} viewBox="0 0 24 29" aria-hidden="true">
  ...
  {:else}
    <path d="M12 1.5l2.6 5.3 5.8.8-4.2 4.1 1 5.8L12 14.8 6.8 17.5l1-5.8-4.2-4.1 5.8-.8Z" fill={metal.fill} stroke={metal.shade} stroke-width="0.8" />
